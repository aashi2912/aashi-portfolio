            ...
            <div className="mt-16 flex flex-col sm:flex-row sm:gap-16">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-3">
                  <a href="https://www.linkedin.com/in/aashithakkar29/" target="_blank" rel="noopener noreferrer" className="flex-1 inline-flex items-center justify-center gap-2 rounded-full border border-border px-6 py-3 text-[15px] font-medium transition-colors hover:bg-accent">Hire Me <FileText size={16} /></a>
