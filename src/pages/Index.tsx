      ...
      <section id="home" className="scroll-mt-20 relative overflow-hidden">
        ...
        <motion.div
          ...
          <img
            ...
            className="w-full h-full object-cover parallax-hero dark:invert dark:brightness-[0.85] dark:contrast-[0.85]"
            style={{ transform: `translateY(${heroParallax}px)` }} />
          
          <h2 className="absolute top-8 sm:top-12 md:top-16 left-0 right-0 text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight text-center px-4 text-black dark:text-white">
