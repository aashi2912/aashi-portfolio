...
const roles = ["Senior Product Manager, Data and AI.", "Software Developer.", "Vibe Coder.", "Lifelong Learner."];
...
const experiences = [
{
  role: "Senior Product Manager, Data and AI",
...
const skillCategories = [
{
  ...
  items: ["Communication", "Stakeholder Management", "Critical Thinking", "User Research", "Product Strategy", "Product Strategy & Roadmap", "0-to-1 / Conception-to-Launch", "Go-to-Market", "Project Management", "Market Research", "Design Systems", "Competitive Analysis", "Data Analysis", "A/B Testing", "Experimentation", "Product Integration", "Data Visualization", "Product Localization", "Product Vision", "Roadmap Planning", "Feature Prioritization", "Product Lifecycle Management", "Product Launch Execution", "Agile/Scrum", "Backlog Grooming", "User Stories", "Acceptance Criteria", "Cross-functional Collaboration", "PRDs", "BRDs", "Functional Specifications", "Data Flow Diagrams", "Process Modeling (BPM)", "UAT", "Requirements Gathering"]
},
{
  name: "AI/ML",
  items: ["GenAI", "LLMs", "AI Agents", "Retrieval-Augmented Generation (RAG)", "Prompt Engineering", "NLP", "Embeddings", "Vector Search", "Model Evaluation & Guardrails", "Model Evaluation Metrics", "Responsible AI"]
},
{
  name: "Languages",
