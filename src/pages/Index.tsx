        ...
        <section id="about">
          ...
          <div className="relative w-full" style={{ minHeight: "1100px" }}>
            {[
              ...
              { emoji: "🏺", title: "Pottery", caption: "Moulding clay into something beautiful", rotate: "-4deg", top: "540px", left: "3%", width: "220px", delay: 0.42, pin: "hsl(280,60%,55%)", image: hobbyPottery, imagePos: "center 30%" },
