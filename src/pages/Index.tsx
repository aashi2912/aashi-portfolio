      ...
      <ContentWrap className="py-24 scroll-mt-20">
        <section id="about">
          ...
          <div className="relative w-full" style={{ minHeight: "1050px" }}>
            ...
            { emoji: "🤿", title: "Snorkelling", caption: "Discovering the world beneath the waves", rotate: "-2.5deg", top: "160px", left: "68%", width: "195px", delay: 0.26, pin: "hsl(200,70%,50%)", image: hobbySnorkelling },
            ...
            { emoji: "🥾", title: "Hiking", caption: "Chasing trails & mountain views", rotate: "2.5deg", top: "340px", left: "69%", width: "195px", delay: 0.5, pin: "hsl(25,80%,50%)", image: hobbyHiking },
