    ...
    <div className="py-10 md:py-14 relative">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="relative bg-[hsl(200,60%,92%)] dark:bg-[hsl(200,40%,18%)] border border-[hsl(200,50%,80%)] dark:border-[hsl(200,40%,30%)] rounded-2xl rounded-tl-sm p-5 md:p-6">
            ...
            <div className="mt-4 flex items-center gap-2">
              {active.companyLogo ? (
                <img src={active.companyLogo} alt={active.company} className="h-4 object-contain shrink-0" />
              ) : (
                <div
